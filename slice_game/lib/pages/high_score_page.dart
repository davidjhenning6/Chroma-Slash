        ...
        header: Container(
          ...
          child: Row(
                ...
                children: [
                  Column(
                    children: [
                      Text("Rank", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF))),
                    ],
                  ),
                  Column(
                    children: [
                      Text("Name", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF))),
                    ],
                  ),
                  Column(
                    children: [
                      Text("Score", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF))),
                    ],
                  ),
                ],
              ),
        ...
        content: Container(
          child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text("${Server.highScores[index].name}", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  Column(
                    children: [
                      Text("${Server.highScores[index].score}", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ],
              ),
